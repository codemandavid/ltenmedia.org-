    		...
    		<div class="site-footer-top">
            	<div class="row">
                	...
                	<div class="col-md-4 widget footer_widget newsletter_widget">
                        ...
                        <hr class="sm">
                        <p>Subscribe to our newsletter in order to receive the latest new &amp; Updates from us.</p>
        		...
        		<div class="quick-info">
                    <div class="row">
                        <div class="col-md-3 col-sm-6">
                            ...
                            <p>Saturdays @ 11:00 am<br>Sundays @ 03:00 pm</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <h4><i class="fa fa-map-marker"></i> Our Location</h4>
                            <p> 15,Nova Road, Off Ugbowo Road  <br> Wasota Junction Benin City.</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <h4><i class="fa fa-envelope"></i> Contact Info</h4>
                            <p>0816 - 879 - 7332 <br>lten.lightoftruthen@gmail.com</p>
                        </div>
                        <div class="col-md-3 col-sm-6">
                            <h4><i class="fa fa-clock-o"></i> Follow us social Media</h4>
                            <ul class="social-icons-colored inversed">
                                <li class="facebook"><a href="https://facebook.com/lightoftruthequippingnetwork" target="_blank"><i class="fa fa-facebook"></i></a></li>
        		...
        		<div class="site-footer-bottom">
            		<div class="row">
                		<div class="col-md-6 col-sm-6 copyrights-coll">
        					&copy; 2019 light of TruthEquipping Network. All Rights Reserved
            			</div>
                		<div class="col-md-6 col-sm-6 copyrights-colr">
        					<nav class="footer-nav" role="navigation">
                        		Designed by : davidchijioke11@gmail.com
                        	</nav>
            			</div>
                   	</div>
               	</div>
...
<div class="quick-info-overlay">
	<div class="quick-info-overlay-left accent-bg">
        <a href="index.htm#" class="btn-close"><i class="icon-delete"></i></a>
    	<div class="event-info">
    		<h3 class="event-title"></h3>
      		<div class="event-address"></div>
            <a href="index.htm" class="btn btn-default btn-transparent btn-permalink">Full details</a>
        </div>
    </div>
...
<div class="ticket-booking-wrapper">
    <a href="index.htm#" class="ticket-booking-close label-danger"><i class="icon icon-delete"></i></a>
                            ...
                            <div class="event-ticket-right-inner">
                                ...
                                <div class="event-ticket-info">
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <a href="index.htm#" class="btn btn-warning btn btn-block ticket-col">Book</a>
                                        </div>
                                        <div class="col">
...
<script src="../../../maps.googleapis.com/maps/api/js-key=AIzaSyB-SpgMgJfnYGQYrkDIYKMuw0keyeNtqL0.htm"></script>
