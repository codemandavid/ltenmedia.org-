    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Uploaded E-Books</h4>
               <?php 
              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                                         <?php 
                $query= "SELECT *  FROM ebooks $limit";
                ...
                <tr>
                        <tr>
                            ...
                            <td><?php  echo $fetch['cover_img']; ?></td>
                           
                           <td>
                              <button>
                             <?php
                    $id=$fetch['id'];
                    echo "<a href='delbook.php?rn=$id' class='btn btn-outline-danger'>Delete</a>";
                    ?></button>
                            </td>
                        </tr>
                       <?php $counter++; ?>
