    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div id="right-sidebar" class="settings-panel">
        ...
        <ul class="nav nav-tabs border-top" id="setting-panel" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="todo-tab" data-toggle="tab" href="" role="tab" aria-controls="todo-section" aria-expanded="true">TO DO LIST</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" id="chats-tab" data-toggle="tab" href="" role="tab" aria-controls="chats-section">CHATS</a>
          </li>
        </ul>
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Uploaded Events</h4>
               <?php 
    ...
    ?>
              ...
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                                         <?php 
                $query= "SELECT *  FROM event_table $limit";
                ...
                <tr>
                    ...
                    $id2=$fetch['id']; echo "<a href='editevent.php?po=$id2' class='btn btn-info'>Edit</a>";
                    ?></button>
                            </td>
                            <td>
                              <button>
                             <?php
                    $id=$fetch['id'];
                    echo "<a href='delevent.php?rn=$id' class='btn btn-outline-danger'>Delete</a>";
                    ?></button>
                            </td>
                        </tr>
                       <?php $counter++; ?>
