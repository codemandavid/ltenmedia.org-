    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">
        <div class="content-wrapper">
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">Uploaded BlogPost</h4>
               <?php 
    ...
    ?>
              ...
              <div class="row">
                ...
                <tr>
                    ...
                    $id2=$fetch['id']; echo "<a href='editblog1.php?po=$id2' class='btn btn-info'>Edit</a>";
                    ?></button>
                            </td>
                            <td>
                              <button>
                             <?php
                    $id=$fetch['id'];
                    echo "<a href='delblog.php?rn=$id' class='btn btn-outline-danger'>Delete</a>";
                    ?></button>
                            </td>
                        </tr>
                       <?php $counter++; ?>
