...
if (isset($_POST['delete'])) {
  $id=$_POST["id"];
  $sql= " DELETE FROM message__table WHERE id='".$id."'  ";
  $query= mysqli_query($conn,$sql);
      if ($query) {
        $success= "<p class='alert alert-success'>Member deleted successfully<p>";
        
      }else{
        $error1="<p class='alert alert-danger'>Error Deleting Member</p> " . mysqli_error($conn);
}            
      }
                ...
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <?php 
                $query= "SELECT *  FROM message__table $limit";
