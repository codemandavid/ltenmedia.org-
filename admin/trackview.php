...
<body>
  <div class="container-scroller">
    ...
    ?>
            <div class="card-body">
              <h4 class="card-title">Uploaded Sermons</h4>
              <div class="row">
                <div class="col-12">
                  <div class="table-responsive">
                    <table id="order-listing" class="table">
                      ...
                      <tbody>
                        <?php 
                $query= "SELECT *  FROM sermon_table $limit";
                ...
                ?>
                        <tr>
                            ...
                            <td><?php  echo $fetch['sermon_title']; ?></td>
                            <td><?php  echo $fetch['date']; ?></td>
                          
                            <td>
                               <?php
                    $id=$fetch['id'];
                    echo "<a href='trackdel.php?rn=$id' class='btn btn-outline-danger'>Delete</a>";
                    ?>
                            </td>
                        </tr>
                         <?php $counter++; ?>
